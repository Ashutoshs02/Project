...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $result = $conn->query("SELECT * FROM citizens WHERE id=$id");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $conn->query("UPDATE citizens SET name='$name', mobile_no='$mobile', dob='$dob', gender='$gender' WHERE id=$id");
    echo "<script>alert('Citizen details updated successfully!'); window.location.href='manage_citizen.php';</script>";
}
?>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
        ...
        <div class="border p-4 shadow-lg rounded bg-light" style="width: 50%; max-width: 500px;">
            <h2 class="text-center mb-4 bg-primary text-white py-2 rounded">EDIT &nbsp; CITIZEN &nbsp; DETAILS</h2>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="mobile_no" value="<?= $row['mobile_no'] ?>" class="form-control" required>
        </div>
        <div class="mb-3">
            <label class="form-label">Date of Birth</label>
            <input type="date" name="dob" value="<?= $row['dob'] ?>" class="form-control" required>
        </div>
        <div class="mb-3">
    ...
    <a href="manage_citizen.php" class="btn btn-secondary  mx-4">BACK</a>
</div>
    </form>
</div>
</main>
