  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h1>Take Charge of Your Vote</h1>
        <p>Make your decision-making process modern, secure, and effective.
...
<section class ="my-5">
  <div class="py-5">
     <h1 class="text-center my-heading">An online voting system with your needs at the forefront.</h1>
  </div>
      <!-- About --> 
  <div class="container-fluid">
  <div class="row">
    <div class="col-lg-6 col-md-6 col-12"> 
    <img src="p3.jpeg" class="img-fluid w-100 h-auto" style="max-height: 350px;">
  </div>
        <div class="col-lg-6 col-md-6 col-12">
        <h1 class="text-primary fw-bold">What is an Online Voting System?</h1>
        <p class="py-4"> An online voting system is a software platform that allows groups to securely conduct votes and elections.
            ...
            They eliminate the need to gather in-person, cast votes using paper, or by any other means (e.g. email, insecure survey software).
        </p>
    ...
    <div class="row">
     <!-- Card 1 -->
        <div class="col-lg-4 col-md-4 col-12 d-flex justify-content-center mb-3">
            <div class="card" style="width: 18rem;">
                <img src="p5.png" class="card-img-top" alt="...">
                <div class="card-body">   
                    <p class="card-text">"Your vote is your voice—it reflects your beliefs, influences decisions, and shapes the future.
                       Every vote empowers you to participate in democracy and drive meaningful change."
</p>
      ...
      <!-- Card 2 -->
        <div class="col-lg-4 col-md-4 col-12 d-flex justify-content-center mb-3">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">                   
                    <p class="card-text">"Vote online allows secure, convenient, and fast participation in elections using digital platforms. 
                      It enhances accessibility, reduces paperwork, and ensures a smooth democratic process."                     
</p>
      ...
      <!-- Card 3 -->
        <div class="col-lg-4 col-md-4 col-12 d-flex justify-content-center mb-3">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    <p class="card-text">"Your vote matters because it shapes policies, influences leadership, and ensures representation.
                       Every vote counts in building a fair, democratic, and better future for all."
</p>
